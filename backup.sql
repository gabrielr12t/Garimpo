...
INSERT IGNORE INTO `cat_categorias` (`cat_codigo`, `cat_nome`, `cat_figura`, `est_codigo`) VALUES
...
CREATE TABLE IF NOT EXISTS `com_compras` (
  ...
  `end_codigo` int(11) DEFAULT NULL,
  ...
  KEY `for_codigo` (`for_codigo`),
  CONSTRAINT `com_compras_ibfk_1` FOREIGN KEY (`usu_cpf_cnpj`) REFERENCES `usu_usuarios` (`usu_cpf_cnpj`),
  CONSTRAINT `end_codigo` FOREIGN KEY (`end_codigo`) REFERENCES `end_enderecos` (`end_codigo`),
  CONSTRAINT `env_codigo` FOREIGN KEY (`env_codigo`) REFERENCES `env_formas_envios` (`env_codigo`),
  CONSTRAINT `for_codigo` FOREIGN KEY (`for_codigo`) REFERENCES `for_forma_pagamentos` (`for_codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela garimpao.com_compras: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `com_compras` DISABLE KEYS */;
INSERT IGNORE INTO `com_compras` (`com_codigo`, `com_data`, `com_valor_total`, `usu_cpf_cnpj`, `end_codigo`, `env_codigo`, `for_codigo`) VALUES
	(108, '2018-06-26 15:30:01', 120, '436.606.008-65', 245, 1, 1),
	(109, '2018-06-26 15:45:38', 120, '436.606.008-65', 245, 2, 1);
...
-- Copiando dados para a tabela garimpao.cop_cores_produtos: ~43 rows (aproximadamente)
/*!40000 ALTER TABLE `cop_cores_produtos` DISABLE KEYS */;
INSERT IGNORE INTO `cop_cores_produtos` (`cor_cod`, `pro_codigo`) VALUES
	(2, 105),
	(10, 106),
	(4, 108),
	(2, 109),
...
INSERT IGNORE INTO `cor_cores` (`cor_codigo`, `cor_nome`, `cor_imagem`) VALUES
...
-- Copiando dados para a tabela garimpao.end_enderecos: ~19 rows (aproximadamente)
/*!40000 ALTER TABLE `end_enderecos` DISABLE KEYS */;
INSERT IGNORE INTO `end_enderecos` (`end_codigo`, `end_cep`, `end_estado`, `end_cidade`, `end_bairro`, `end_endereco`, `end_referencia`, `end_numero`, `usu_cpf_cnpj`) VALUES
	...
	(246, '12518-110', 'SP', 'Guaratinguetá', 'Parque do Sol', 'Rua Antônio Galhardo', 'casa', 484, '382.229.055-44'),
	(249, '12518-110', 'SP', 'Guaratinguetá', 'Parque do Sol', 'Rua Antônio Galhardo', '', 21, '121.212.214-32'),
	(250, '12518-110', 'SP', 'Guaratinguetá', 'Parque do Sol', 'Rua Antônio Galhardo', '', 668, '554.114.788-83'),
	(251, '12515-070', 'SP', 'Guaratinguetá', 'Pedregulho', 'Rua Francisco Santos Reis', '', 112, '558.971.111-11'),
	(252, '12520-320', 'SP', 'Guaratinguetá', 'Vila Brasil', 'Rua Argentina', '', 331, '554.123.654-41');
...
-- Copiando dados para a tabela garimpao.enp_envio_produtos: ~29 rows (aproximadamente)
/*!40000 ALTER TABLE `enp_envio_produtos` DISABLE KEYS */;
INSERT IGNORE INTO `enp_envio_produtos` (`pro_codigo`, `env_codigo`) VALUES
	(105, 1),
	(106, 1),
	(108, 1),
	(109, 1),
...
INSERT IGNORE INTO `env_formas_envios` (`env_codigo`, `env_nome`) VALUES
	(1, 'Correios'),
	(2, 'Em mãos'),
	(3, 'Grátis');
...
INSERT IGNORE INTO `est_estilos` (`est_codigo`, `est_nome`, `est_figura`, `usu_cpf_cnpj`) VALUES
	(17, 'Geek', NULL, '1'),
	(18, 'Nerd', NULL, '1'),
	(19, 'Rock', NULL, '1'),
	(20, 'Hipster', NULL, '1'),
...
-- Copiando dados para a tabela garimpao.fav_favoritos: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `fav_favoritos` DISABLE KEYS */;
INSERT IGNORE INTO `fav_favoritos` (`usu_cpf`, `pro_codigo`) VALUES
	('217.832.455-52', 105),
	('217.832.455-52', 106),
	('457.897.465-13', 106),
	('217.832.455-52', 108),
...
-- Copiando dados para a tabela garimpao.for_forma_pagamentos: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `for_forma_pagamentos` DISABLE KEYS */;
INSERT IGNORE INTO `for_forma_pagamentos` (`for_codigo`, `for_pagamento`) VALUES
	(1, 'Boleto');
...
-- Copiando dados para a tabela garimpao.fot_fotos: ~51 rows (aproximadamente)
/*!40000 ALTER TABLE `fot_fotos` DISABLE KEYS */;
INSERT IGNORE INTO `fot_fotos` (`fot_codigo`, `fot_url`, `pro_codigo`) VALUES
	...
	(519, '\\Fotos\\Produtos\\240620180946716.png', 126),
	(520, '\\Fotos\\Produtos\\250620180821436.jpg', 127),
	(521, '\\Fotos\\Produtos\\250620180825403.jpg', 127),
	(522, '\\Fotos\\Produtos\\260620183029864.jpg', 128),
	(523, '\\Fotos\\Produtos\\260620183029940.jpg', 128),
	(524, '\\Fotos\\Produtos\\260620183030048.jpg', 128),
	(525, '\\Fotos\\Produtos\\260620184246285.jpg', 129),
	(526, '\\Fotos\\Produtos\\260620184246223.jpg', 129),
	(527, '\\Fotos\\Produtos\\260620184246417.jpg', 129);
...
CREATE TABLE IF NOT EXISTS `ite_itens` (
  ...
  `ite_avaliacao` tinyint(4) DEFAULT NULL,
  `ite_status` int(11) DEFAULT NULL,
  `pro_codigo` int(11) NOT NULL,
...
-- Copiando dados para a tabela garimpao.ite_itens: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `ite_itens` DISABLE KEYS */;
INSERT IGNORE INTO `ite_itens` (`ite_quantidade`, `ite_avaliacao`, `ite_status`, `pro_codigo`, `com_codigo`) VALUES
	(1, 1, 3, 108, 108),
	(1, 0, 3, 108, 109);
...
-- Copiando dados para a tabela garimpao.mar_marcas: ~32 rows (aproximadamente)
/*!40000 ALTER TABLE `mar_marcas` DISABLE KEYS */;
INSERT IGNORE INTO `mar_marcas` (`mar_codigo`, `mar_nome`, `mar_logo`, `mar_status`, `usu_cpf_cnpj`) VALUES
	...
	(63, 'Chiquiteira', NULL, NULL, '121.212.214-32'),
	(64, 'Zara', NULL, NULL, '554.123.654-41');
...
-- Copiando dados para a tabela garimpao.men_mensagens: ~403 rows (aproximadamente)
/*!40000 ALTER TABLE `men_mensagens` DISABLE KEYS */;
INSERT IGNORE INTO `men_mensagens` (`men_codigo`, `men_conteudo`, `men_moderacao_status`, `men_arquivada`, `men_data`, `men_lida`, `usu_cpf_cnpj`, `pro_codigo`, `tme_codigo`, `men_pergunta_codigo`, `men_cpf_pergunta`, `men_respondida`, `men_visivel`) VALUES
	(65, 'Seja muito bem-vindo Sr(a) gabriel de paula  ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-05-25 20:17:11', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	...
	(148, 'Seja muito bem-vindo Sr(a) Costa freire ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-05-26 02:48:37', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(149, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-05-26 02:49:53', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	...
	(152, 'Sr(a) Costa freire, seu produto foi aprovado no sistema.', NULL, NULL, '2018-05-26 02:54:35', 1, '457.897.465-13', 112, 5, NULL, NULL, NULL, 0),
	...
	(167, 'você tem ela ainda?', NULL, NULL, '2018-05-26 04:25:47', 1, '457.897.465-13', 112, 2, '260520182547740', '756.475.445-11', 1, 0),
	...
	(203, 'Olá sr(a) joana Krat você efetuou o cadastro do seu produto Bolsa Metallica, agora é só aguardar os administradores aceitarem para que seu produto fique ativo. seu produto cadastrado foi um(a) Bolsa Metallicacom1 unidade(s)', NULL, NULL, '2018-05-26 16:53:57', 1, '126.782.342-31', 122, 1, NULL, NULL, NULL, 1),
	...
	(205, 'Sr(a) joana Krat, seu produto foi aprovado no sistema.', NULL, NULL, '2018-05-26 16:54:05', 1, '126.782.342-31', 122, 5, NULL, NULL, NULL, 1),
	...
	(228, 'faz por 40?', NULL, NULL, '2018-05-27 03:03:35', 1, '457.897.465-13', 112, 2, '270520180335704', '125.661.223-55', 1, 0),
	...
	(232, 'sim, já já vou cadastrar elas no garimpo', NULL, NULL, '2018-05-27 03:09:55', 1, '445.687.874-51', 114, 3, '260520184519685', NULL, NULL, 1),
	...
	(234, 'envia para Manaus?', NULL, NULL, '2018-05-27 03:11:11', 1, '457.897.465-13', 112, 2, '270520181111440', '216.561.235-55', 1, 0),
	(235, 'não da amigo', NULL, NULL, '2018-05-27 03:11:45', 1, '457.897.465-13', 114, 3, '260520184552013', NULL, NULL, 0),
	...
	(256, 'Olá sr(a) marcelo vidas seu produto recebeu uma denuncia alegando estar com descrição irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a é verídica podendo desativar seu produto.', NULL, NULL, '2018-05-29 23:27:40', 1, '756.475.445-11', 108, 8, NULL, NULL, NULL, 1),
	...
	(262, 'Olá sr(a) Costa freire seu produto recebeu uma denuncia alegando estar com categoria errada, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-05-29 23:36:04', 1, '457.897.465-13', 112, 8, NULL, NULL, NULL, 0),
	...
	(264, 'Olá sr(a) Costa freire seu produto recebeu uma denuncia alegando estar com categoria errada, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-05-29 23:37:54', 1, '457.897.465-13', 112, 8, NULL, NULL, NULL, 0),
	...
	(268, 'Olá sr(a) Costa freire seu produto recebeu uma denuncia alegando estar com descrição irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a é verídica podendo desativar seu produto.', NULL, NULL, '2018-05-29 23:39:40', 1, '457.897.465-13', 112, 8, NULL, NULL, NULL, 0),
	...
	(272, 'Olá sr(a) marcelo vidas seu produto recebeu uma denuncia alegando estar com categoria errada, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-07 17:58:58', 1, '756.475.445-11', 108, 8, NULL, NULL, NULL, 1),
	...
	(294, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 01:45:36', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	(295, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 01:45:36', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	...
	(298, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-08 01:47:25', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(299, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 01:50:02', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	...
	(301, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-08 01:50:33', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(302, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 13:20:05', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	(303, 'Olá sr(a) gabriel de paula  seu produto recebeu uma denuncia alegando estar com foto irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-08 17:54:04', 1, '436.606.008-65', 111, 8, NULL, NULL, NULL, 0),
	...
	(305, 'Olá sr(a) gabriel de paula , este produto recebeu uma denúncia alegando estar com foto irregular ', NULL, NULL, '2018-06-08 17:54:04', 1, '436.606.008-65', 111, 8, NULL, NULL, NULL, 0),
	(306, 'Olá sr(a) gabriel de paula ,seu produto que havia sido constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-08 17:57:16', 1, '436.606.008-65', 105, 1, NULL, NULL, NULL, 0),
	(307, 'Olá sr(a) gabriel de paula ,seu produto que havia sido constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-08 17:57:39', 1, '436.606.008-65', 111, 1, NULL, NULL, NULL, 0),
	...
	(309, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-08 17:58:24', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(310, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 17:59:23', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	(311, 'Olá sr(a) gabriel de paula  seu produto recebeu uma denuncia alegando estar com categoria errada, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-08 18:00:46', 1, '436.606.008-65', 111, 8, NULL, NULL, NULL, 0),
	...
	(313, 'Olá sr(a) gabriel de paula , este produto recebeu uma denúncia alegando estar com categoria errada ', NULL, NULL, '2018-06-08 18:00:46', 1, '436.606.008-65', 111, 8, NULL, NULL, NULL, 0),
	(314, 'Olá sr(a) gabriel de paula ,seu produto que havia sido constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-08 18:01:45', 1, '436.606.008-65', 111, 1, NULL, NULL, NULL, 0),
	(315, 'Olá sr(a) gabriel de paula ,seu produto que havia sido constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-08 18:01:47', 1, '436.606.008-65', 111, 1, NULL, NULL, NULL, 0),
	...
	(319, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 18:06:53', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	...
	(322, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-08 18:31:27', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(323, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 18:31:50', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	...
	(325, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-08 18:33:39', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(326, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-08 18:33:47', 1, '436.606.008-65', 111, 5, NULL, NULL, NULL, 0),
	(327, 'ta online?\r\n', NULL, NULL, '2018-06-08 23:09:06', 1, '457.897.465-13', 112, 2, '080620180906198', '436.606.008-65', NULL, 0),
	...
	(332, 'Olá sr(a) gabriel de paula , o usuário joao da silva inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-11 20:48:39', 1, '436.606.008-65', 125, 1, NULL, NULL, NULL, 0),
	...
	(334, 'tem na cor vermelha?', NULL, NULL, '2018-06-11 20:52:21', 1, '216.561.235-55', 114, 2, '110620185221320', '1', NULL, 1),
	(335, 'Olá sr(a) gabriel de paula  seu produto recebeu uma denuncia alegando estar com foto irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-11 20:58:21', 1, '436.606.008-65', 113, 8, NULL, NULL, NULL, 0),
	...
	(337, 'Olá sr(a) gabriel de paula , este produto recebeu uma denúncia alegando estar com foto irregular ', NULL, NULL, '2018-06-11 20:58:21', 1, '436.606.008-65', 113, 8, NULL, NULL, NULL, 0),
	(338, 'Olá sr(a) gabriel de paula ,seu produto que havia sido constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-11 20:59:10', 1, '436.606.008-65', 113, 1, NULL, NULL, NULL, 0),
	(339, 'Sr(a) gabriel de paula , seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-14 18:04:23', 1, '436.606.008-65', 113, 5, NULL, NULL, NULL, 0),
	(340, 'Olá sr(a) marcelo vidas seu produto recebeu uma denuncia alegando estar com descrição irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a é verídica podendo desativar seu produto.', NULL, NULL, '2018-06-14 18:05:29', 1, '756.475.445-11', 108, 8, NULL, NULL, NULL, 1),
	...
	(342, 'Olá sr(a) gabriel de paula , este produto recebeu uma denúncia alegando estar com descrição irregular ', NULL, NULL, '2018-06-14 18:05:29', 1, '436.606.008-65', 108, 8, NULL, NULL, NULL, 0),
	(343, 'Olá sr(a) marcelo vidas seu produto recebeu uma denuncia alegando estar com foto irregular, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-14 18:12:14', 1, '756.475.445-11', 108, 8, NULL, NULL, NULL, 1),
	...
	(346, 'Olá sr(a) marcelo vidas,seu produto que havia sido denunciado constava erro, pois ele foi desativado, para que ele fique ativo novamente é necessário que arrume-o.', NULL, NULL, '2018-06-14 18:17:22', 1, '756.475.445-11', 108, 1, NULL, NULL, NULL, 0),
	(347, 'Sr(a) marcelo vidas, seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-14 18:17:35', 1, '756.475.445-11', 108, 5, NULL, NULL, NULL, 0),
	(348, 'Olá sr(a) Costa freire seu produto recebeu uma denuncia alegando estar com categoria errada, \r\n                            administradores estarão revisando a denúncia e verificando se a denúncia é verídica', NULL, NULL, '2018-06-14 18:18:00', 1, '457.897.465-13', 112, 8, NULL, NULL, NULL, 0),
	...
	(351, 'Olá sr(a) Costa freire,seu produto que havia sido denunciado foi verificado pelos administradores e não consta erro.', NULL, NULL, '2018-06-14 18:19:18', 1, '457.897.465-13', 112, 1, NULL, NULL, NULL, 0),
	...
	(357, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 17:29:46', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(359, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 17:51:36', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(361, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 17:52:53', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(363, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 17:54:38', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(365, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 17:57:53', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(367, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 18:00:15', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(369, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 18:02:22', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(371, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 18:03:45', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(373, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 18:08:26', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(375, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 18:19:44', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(377, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-18 20:26:18', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	...
	(380, 'Olá sr(a) Administrador, o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-21 18:25:13', 1, '1', 111, 7, NULL, NULL, NULL, NULL),
	(381, 'Olá sr(a) gabriel de paula , o usuário gabriel de paula  alterou um produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-21 18:25:13', 1, '436.606.008-65', 111, 7, NULL, NULL, NULL, 0),
	(382, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$67,50', NULL, NULL, '2018-06-23 22:46:01', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(383, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-24 00:10:06', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(384, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-24 00:11:45', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(385, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$67,50', NULL, NULL, '2018-06-24 00:14:08', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(386, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-24 00:15:29', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(387, 'Olá senhor(a) 436.606.008-65, seu produto Camisa do Guns N\' Roses acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 00:16:25', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(388, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$241.80', NULL, NULL, '2018-06-24 00:52:37', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(389, 'Olá senhor(a) 216.561.235-55, seu produto Caneca Darth Vader Star Wars  acabou de ser vendido com 6 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 00:52:37', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(390, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$90.60', NULL, NULL, '2018-06-24 00:57:23', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(391, 'Olá senhor(a) 216.561.235-55, seu produto Camiseta Guns N\' Roses  acabou de ser vendido com 2 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 00:58:28', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(392, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$53,75', NULL, NULL, '2018-06-24 00:59:51', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(393, 'Olá senhor(a) 216.561.235-55, seu produto Camiseta Guns N\' Roses  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 00:59:51', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(394, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$435.00', NULL, NULL, '2018-06-24 01:01:17', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(395, 'Olá senhor(a) 457.897.465-13, seu produto Camisa Star Wars Darth Vader acabou de ser vendido com 8 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 01:01:17', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(396, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$67,50', NULL, NULL, '2018-06-24 01:04:16', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(397, 'Olá senhor(a) Costa Freire, seu produto Camisa Star Wars Darth Vader acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 01:04:16', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(398, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$64,34', NULL, NULL, '2018-06-24 01:11:25', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(399, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120.00', NULL, NULL, '2018-06-24 01:13:31', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(400, 'Olá senhor Costa freire, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$141,00', NULL, NULL, '2018-06-24 01:16:57', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(401, 'Olá senhor Costa freire, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$172,50', NULL, NULL, '2018-06-24 01:27:04', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(402, 'Olá senhor Costa freire, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$172,50', NULL, NULL, '2018-06-24 01:29:08', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(403, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$30,75', NULL, NULL, '2018-06-24 01:36:06', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(404, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-24 01:42:13', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(405, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120,00', NULL, NULL, '2018-06-24 01:44:30', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(406, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$36,00', NULL, NULL, '2018-06-24 01:46:23', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(407, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$36,00', NULL, NULL, '2018-06-24 01:47:19', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(408, 'Olá senhor(a) 445.687.874-51, seu produto geek girly acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 01:47:19', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(409, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$200,83', NULL, NULL, '2018-06-24 01:49:52', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(413, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$78,00', NULL, NULL, '2018-06-24 01:50:47', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 0),
	(414, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$85,34', NULL, NULL, '2018-06-24 01:54:28', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 0),
	(417, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$169,34', NULL, NULL, '2018-06-24 01:57:07', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(418, 'Olá senhor(a) joana Krat, seu produto cropped amarelo geek acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 01:57:10', 1, '126.782.342-31', NULL, 1, NULL, NULL, NULL, 1),
	(419, 'Olá senhor(a) antonio almeida, seu produto Camiseta Guns N\' Roses  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 01:57:10', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(420, 'Olá senhor alana campos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$78,00', NULL, NULL, '2018-06-24 02:01:43', 1, '155.477.841-11', NULL, 1, NULL, NULL, NULL, 1),
	(421, 'Olá senhor(a) nerd girl, seu produto geek girly acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 02:01:43', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(422, 'Olá senhor(a) gabriel de paula , seu produto Call Of Duty - Black Ops  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 02:01:43', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(423, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$64,34', NULL, NULL, '2018-06-24 02:04:11', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(424, 'Olá senhor(a) antonio almeida, seu produto Camiseta Guns N\' Roses  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 02:04:11', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(425, 'Olá senhor nerd girl, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120,00', NULL, NULL, '2018-06-24 15:22:54', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(426, 'Olá senhor(a) joana Krat, seu produto cropped amarelo geek acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 15:22:54', 1, '126.782.342-31', NULL, 1, NULL, NULL, NULL, 1),
	(427, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$855.00', NULL, NULL, '2018-06-24 15:25:32', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(428, 'Olá senhor(a) joana Krat, seu produto cropped amarelo geek acabou de ser vendido com 8 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 15:25:32', 1, '126.782.342-31', NULL, 1, NULL, NULL, NULL, 1),
	(429, 'Olá senhor nerd girl, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120.00', NULL, NULL, '2018-06-24 18:44:46', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(430, 'Olá senhor(a) Costa freire, seu produto Camisa Star Wars Darth Vader acabou de ser vendido com 2 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 18:44:46', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(431, 'Olá senhor nerd girl, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$46,49', NULL, NULL, '2018-06-24 18:51:59', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(432, 'Olá senhor(a) Costa freire, seu produto Camisa de programador acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 18:51:59', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 0),
	(433, 'Seja muito bem-vindo Sr(a) Rafael de Paula Santos ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-06-24 23:02:17', 1, '382.229.055-44', NULL, 1, NULL, NULL, NULL, 1),
	(434, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-06-24 23:04:07', 1, '382.229.055-44', NULL, 1, NULL, NULL, NULL, 1),
	(435, 'Olá senhor Rafael de Paula Santos, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$56,99', NULL, NULL, '2018-06-24 23:06:21', 1, '382.229.055-44', NULL, 1, NULL, NULL, NULL, 1),
	(436, 'Olá senhor(a) teste alterar, seu produto Caneca Guns N\' Roses acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-24 23:06:21', 0, '111.256.734-54', NULL, 1, NULL, NULL, NULL, 1),
	(437, 'Olá sr(a) Rafael de Paula Santos você efetuou o cadastro do seu produto Camisa, agora é só aguardar os administradores aceitarem para que seu produto fique ativo. seu produto cadastrado foi um(a) Camisacom1 unidade(s)', NULL, NULL, '2018-06-24 23:09:59', 1, '382.229.055-44', 126, 1, NULL, NULL, NULL, 1),
	(438, 'Olá sr(a) Administrador, o usuário Rafael de Paula Santos inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-24 23:09:59', 1, '1', 126, 1, NULL, NULL, NULL, NULL),
	(439, 'Olá sr(a) gabriel de paula , o usuário Rafael de Paula Santos inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-24 23:09:59', 1, '436.606.008-65', 126, 1, NULL, NULL, NULL, NULL),
	(440, 'você tem camisas de futebol ?', NULL, NULL, '2018-06-24 23:11:12', 1, '436.606.008-65', 113, 2, '240620181112081', '382.229.055-44', 1, 1),
	(448, 'Sr(a) Rafael de Paula Santos, seu produto não foi aprovado no sistema, modifique-o para uma nova moderação', NULL, NULL, '2018-06-25 02:03:46', 0, '382.229.055-44', 126, 6, NULL, NULL, NULL, 1),
	(449, 'Sr(a) marcelo vidas, seu produto não foi aprovado no sistema, modifique-o para uma nova moderação', NULL, NULL, '2018-06-25 02:03:47', 1, '756.475.445-11', 111, 6, NULL, NULL, NULL, 0),
	(450, 'não tenho', NULL, NULL, '2018-06-25 02:04:08', 0, '382.229.055-44', 113, 3, '240620181112081', NULL, NULL, 1),
	(451, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$172.50', NULL, NULL, '2018-06-25 02:07:52', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(452, 'Olá senhor(a) Costa freire, seu produto Camisa Star Wars Darth Vader acabou de ser vendido com 3 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-25 02:07:52', 1, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 1),
	(453, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$166.20', NULL, NULL, '2018-06-25 02:16:10', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(454, 'Olá senhor(a) antonio almeida, seu produto Caneca Darth Vader Star Wars  acabou de ser vendido com 4 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-25 02:16:10', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(455, 'Seja muito bem-vindo Sr(a) Cardoso Marques ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-06-25 03:29:47', 1, '121.212.214-32', NULL, 1, NULL, NULL, NULL, 1),
	(456, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-06-25 03:31:20', 1, '121.212.214-32', NULL, 1, NULL, NULL, NULL, 1),
	(457, 'Olá senhor Cardoso Marques, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$53,75', NULL, NULL, '2018-06-25 03:43:09', 1, '121.212.214-32', NULL, 1, NULL, NULL, NULL, 0),
	(458, 'Olá senhor(a) antonio almeida, seu produto Caneca Darth Vader Star Wars  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-25 03:43:09', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(459, 'Olá sr(a) Cardoso Marques você efetuou o cadastro do seu produto Bota Rock, agora é só aguardar os administradores aceitarem para que seu produto fique ativo. seu produto cadastrado foi um(a) Bota Rockcom9 unidade(s)', NULL, NULL, '2018-06-25 04:09:22', 1, '121.212.214-32', 127, 1, NULL, NULL, NULL, 1),
	(460, 'Olá sr(a) Administrador, o usuário Cardoso Marques inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-25 04:09:22', 1, '1', 127, 1, NULL, NULL, NULL, NULL),
	(461, 'Olá sr(a) gabriel de paula , o usuário Cardoso Marques inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-25 04:09:22', 1, '436.606.008-65', 127, 1, NULL, NULL, NULL, NULL),
	(462, 'Sr(a) Cardoso Marques, seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-25 04:19:32', 1, '121.212.214-32', 127, 5, NULL, NULL, NULL, 1),
	(463, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$53,75', NULL, NULL, '2018-06-25 15:28:52', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(464, 'Olá senhor(a) antonio almeida, seu produto Caneca Darth Vader Star Wars  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-25 15:28:52', 1, '216.561.235-55', NULL, 1, NULL, NULL, NULL, 1),
	(465, 'Olá senhor nerd girl, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-26 14:17:32', 1, '445.687.874-51', NULL, 1, NULL, NULL, NULL, 1),
	(466, 'Olá senhor(a) gabriel de paula , seu produto Call Of Duty - Black Ops  acabou de ser vendido com 3 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-26 14:17:32', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(467, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$67,50', NULL, NULL, '2018-06-26 15:07:25', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(468, 'Olá senhor(a) Costa freire, seu produto Camisa Star Wars Darth Vader acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-26 15:07:25', 0, '457.897.465-13', NULL, 1, NULL, NULL, NULL, 1),
	(469, 'Olá senhor Cardoso Marques, sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$57,00', NULL, NULL, '2018-06-26 15:10:51', 0, '121.212.214-32', NULL, 1, NULL, NULL, NULL, 1),
	(470, 'Olá senhor(a) gabriel de paula , seu produto Call Of Duty - Black Ops  acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-26 15:10:51', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(471, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120,00', NULL, NULL, '2018-06-26 15:30:04', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(472, 'Olá senhor(a) marcelo vidas, seu produto cropped amarelo geek acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-26 15:30:04', 1, '756.475.445-11', NULL, 1, NULL, NULL, NULL, 1),
	(473, 'Olá senhor gabriel de paula , sua compra no garimpo foi efetuada com sucesso podendo ser acompanha em seu perfil na aba suas compras, num total de R$120,00', NULL, NULL, '2018-06-26 15:45:41', 1, '436.606.008-65', NULL, 1, NULL, NULL, NULL, 1),
	(474, 'Olá senhor(a) marcelo vidas, seu produto cropped amarelo geek acabou de ser vendido com 1 unidade(s). Confira na aba Histórico de vendas em seu perfil.', NULL, NULL, '2018-06-26 15:45:41', 0, '756.475.445-11', NULL, 1, NULL, NULL, NULL, 1),
	(475, 'Seja muito bem-vindo Sr(a) Comprador Garimpo ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-06-26 18:27:34', 1, '554.114.788-83', NULL, 1, NULL, NULL, NULL, 1),
	(476, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-06-26 18:29:18', 1, '554.114.788-83', NULL, 1, NULL, NULL, NULL, 1),
	(477, 'Olá sr(a) Comprador Garimpo você efetuou o cadastro do seu produto Camisa Superman, agora é só aguardar os administradores aceitarem para que seu produto fique ativo. seu produto cadastrado foi um(a) Camisa Supermancom10 unidade(s)', NULL, NULL, '2018-06-26 18:30:30', 1, '554.114.788-83', 128, 1, NULL, NULL, NULL, 1),
	(478, 'Olá sr(a) Administrador, o usuário Comprador Garimpo inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-26 18:30:30', 0, '1', 128, 1, NULL, NULL, NULL, NULL),
	(479, 'Olá sr(a) gabriel de paula , o usuário Comprador Garimpo inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-26 18:30:30', 0, '436.606.008-65', 128, 1, NULL, NULL, NULL, NULL),
	(480, 'Sr(a) Comprador Garimpo, seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-26 18:31:21', 1, '554.114.788-83', 128, 5, NULL, NULL, NULL, 1),
	(481, 'Seja muito bem-vindo Sr(a) Comprador Garimpo ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-06-26 18:36:29', 0, '558.971.111-11', NULL, 1, NULL, NULL, NULL, 1),
	(482, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-06-26 18:37:20', 0, '558.971.111-11', NULL, 1, NULL, NULL, NULL, 1),
	(483, 'Seja muito bem-vindo Sr(a) Vendedor Garimpo ao Garimpo, aqui você pode vender seus produtos e também comprar novos produtos', NULL, NULL, '2018-06-26 18:38:41', 0, '554.123.654-41', NULL, 1, NULL, NULL, NULL, 1),
	(484, 'Você finalizou o cadastro Sr(a)  no Garimpo, agora você pode comprar e vender', NULL, NULL, '2018-06-26 18:39:47', 0, '554.123.654-41', NULL, 1, NULL, NULL, NULL, 1),
	(485, 'Olá sr(a) Vendedor Garimpo você efetuou o cadastro do seu produto Moleton Dragon Ball, agora é só aguardar os administradores aceitarem para que seu produto fique ativo. seu produto cadastrado foi um(a) Moleton Dragon Ballcom10 unidade(s)', NULL, NULL, '2018-06-26 18:42:46', 0, '554.123.654-41', 129, 1, NULL, NULL, NULL, 1),
	(486, 'Olá sr(a) Administrador, o usuário Vendedor Garimpo inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-26 18:42:46', 0, '1', 129, 1, NULL, NULL, NULL, NULL),
	(487, 'Olá sr(a) gabriel de paula , o usuário Vendedor Garimpo inseriu um novo produto no sistema, irá aparecer na página Moderar Produtos, Atenciosamente Garimpo.', NULL, NULL, '2018-06-26 18:42:46', 0, '436.606.008-65', 129, 1, NULL, NULL, NULL, NULL),
	(488, 'Sr(a) Vendedor Garimpo, seu produto foi aprovado no sistema.', NULL, NULL, '2018-06-26 18:43:16', 0, '554.123.654-41', 129, 5, NULL, NULL, NULL, 1);
...
-- Copiando dados para a tabela garimpao.pro_produtos: ~24 rows (aproximadamente)
/*!40000 ALTER TABLE `pro_produtos` DISABLE KEYS */;
INSERT IGNORE INTO `pro_produtos` (`pro_codigo`, `pro_nome`, `pro_descricao`, `pro_condicao`, `pro_preco`, `pro_preco_antigo`, `pro_peso`, `pro_medida`, `pro_quantidade`, `pro_status`, `pro_moderacao_status`, `pro_acesso`, `usu_cpf_cnpj`, `mar_codigo`, `sub_codigo`) VALUES
	(105, 'Camisa do Guns N\' Roses', 'regata cavada com franja, estampa guns n roses.\r\nmaterial: algodão e poliéster.\r\nfico a disposição para mais informações!', 'novo', 15.00, 30.00, NULL, 'P', 11, 1, 1, 92, '436.606.008-65', 54, 79),
	(106, 'geek girly', 'camiseta "geek" com costura na dobra da manga', 'novo', 20.00, 45.00, NULL, 'M', 10, 1, 1, 136, '436.606.008-65', 54, 72),
	(108, 'cropped amarelo geek', 'camiseta cropped amarela\r\ntamanho g, mas pode ser usada como oversize', 'novo', 100.00, 99.00, NULL, 'M', 59, 1, 1, 362, '756.475.445-11', 55, 72),
	(109, 'All Star superman', 'converse all star original de cano alto\r\nusado pouquíssimas vezes (2 pra ser exata)\r\nmodelo chuck taylor de tecido todo coloridão \r\noficial da dc comics superman\r\nedição limitada\r\ntamanho: 7 (fem. usa) equivalente ao 36 bra\r\n24 cm de comprimento', 'usado', 60.00, 50.00, NULL, '36', 7, 1, 1, 27, '445.687.874-51', 56, 93),
	(110, ' Tênis para Gamers e Geeks', 'ande com o tênis do seu jogo favorito.', 'novo', 0.00, 0.00, NULL, '35', 9, 1, 1, 15, '125.661.223-55', 50, 93),
	(111, 'ALTERANDO', 'Essa é a descrição alterada', 'novo', 12.00, 12.00, NULL, '', 12, 0, 2, 26, '436.606.008-65', 33, 77),
	(112, 'Camisa Star Wars Darth Vader', 'Malha 100% poliéster com toque de algodão, muito confortável e leve.\r\nEstampa digital de alta durabilidade, com cores vivas e imagens em alta resolução.\r\nÉ possível colocar em máquina de lavar e passar ferro quente sobre a estampa até 40º c.', 'novo', 50.00, 0.00, NULL, 'G', 6, 1, 1, 322, '457.897.465-13', 57, 72),
	(113, 'Call Of Duty - Black Ops ', 'Malha 100% poliéster com toque de algodão, muito confortável e leve.\r\nEstampa digital de alta durabilidade, com cores vivas e imagens em alta resolução.\r\nÉ possível colocar em máquina de lavar e passar ferro quente sobre a estampa até 40º c.', 'novo', 40.00, 0.00, NULL, 'M', 23, 1, 1, 335, '436.606.008-65', 57, 151),
	(114, 'Caneca Darth Vader Star Wars ', 'A caneca que aliada ao lado negro do seu café vai te dar toda força necessaria para o dia todo!\r\n', 'novo', 36.90, 45.50, NULL, '', 4, 1, 1, 364, '216.561.235-55', 58, 311),
	(115, 'Tênis Sonic', 'Sensação natural e energizada a partir do momento em que você pisar pela primeira vez é o que este calçado oferece.', 'novo', 190.00, 0.00, NULL, '37', 34, 1, 1, 14, '218.924.567-22', 50, 165),
	(116, 'caneca Magica 3d ', 'Numa galaxia distancia na transição da República ao Império , Anakin Skywalker foi para o lado negro da Força. ', 'novo', 49.00, 0.00, NULL, '', 4, 1, 1, 18, '155.477.841-11', 33, 311),
	(117, 'Camisa de programador', 'Camiseta 100% poliéster\r\nEstampa sublimada\r\nNão descasca, não desbota\r\nMalha de ótima qualidade\r\nCor da camiseta: BRANCA ou CINZA', 'novo', 29.99, 50.99, NULL, 'G', 35, 1, 1, 59, '457.897.465-13', 54, 151),
	(118, 'Camiseta Guns N\' Roses ', 'Camiseta 100% poliéster\r\nEstampa sublimada\r\nNão descasca, não desbota\r\nMalha de ótima qualidade', 'novo', 46.99, 75.00, NULL, 'M', 10, 1, 1, 19, '218.924.567-22', 54, 79),
	(119, 'Caneca Guns N\' Roses', 'Material: Porcelana preta resinada classe AAA (Perfeição e alto brilho); \r\nDimensões da caneca: 8C x 10L x 9,5A; \r\nCapacidade: 325ml; \r\nImpressão: Impressão digital sublimática permanente;', 'novo', 39.99, 0.00, NULL, '', 10, 1, 1, 17, '155.477.841-11', 54, 310),
	(120, 'Tenis Guns N\' Roses', 'TÊNIS GUNS N\' ROSES CANO ALTO TAMANHO 44 PRETO COM ESTAMPAS DOS LADOS E "G N\' R" COSTURADO NA PARTE DE TRÁS', 'novo', 100.00, 0.00, NULL, '44', 10, 1, 1, 9, '125.661.223-55', 54, 262),
	(121, 'Bolsa Slipknot', '18” Medidas: 32 cm de comprimento 42 cm de altura e 16 cm de profundidade Composição: 95%poliéster / 5% PVC PRETO', 'novo', 99.99, 0.00, NULL, '', 10, 1, 1, 15, '126.782.342-31', 60, 264),
	(122, 'Bolsa Metallica', 'BOLSA SACOLA TIRACOLO\r\nBRIM 100%ALGODÃO DUBLADO\r\nFORRO EM MICRO FIBRA\r\nESTAMPA SILK SCREEN\r\nCOM FECHO CENTRAL BOTÃO DE PRESSÃO', 'novo', 64.99, 0.00, NULL, '', 28, 1, 1, 11, '125.661.223-55', 61, 263),
	(123, 'Relógio De Pulso Hard Rock', 'Relógio Personalizado Logo Banda de Rock AC DC\r\nBateria Original Sony Made In Japan\r\nMecanismo: O relógio e dotado de um mecanismo denominado MIYOTA. Sendo este parte integrante de modelos famosos como Citizen.', 'novo', 250.05, 0.00, NULL, '', 54, 1, 1, 7, '155.477.841-11', 54, 247),
	(124, 'Bolsa me mine', 'Bolsa Para Colorir Color Me Mine Hipster da Dtc É Ideal Para Meninas Acima de 6 Anos.\r\nbolsa Para Pintar Como Quiser! Deixe a Tinta Secar e Depois É Só Usar a Bolsa com Um Superlook Todo Seu!\r\nacompanha 5 Canetas Permanentes Coloridas. ', 'novo', 59.99, 0.00, NULL, '', 10, 1, 1, 7, '756.475.445-11', 54, 125),
	(125, 'tenis', 'tesnis de joga bola', 'usado', 1000.00, 0.00, NULL, '', 12, 1, 1, 8, '126.782.342-31', 62, 103),
	(126, 'Camisa', 'De Algodão', 'novo', 15.00, 0.00, NULL, 'M', 10, 1, 2, 0, '382.229.055-44', 61, 149),
	(127, 'Bota Rock', 'bota de couro especial para você', 'novo', 130.00, 0.00, NULL, '39', 9, 0, 1, 2, '121.212.214-32', 63, 258),
	(128, 'Camisa Superman', 'Super Camisa de compressão 3D SUPER MAN, dos mais famosos heróis do momento, material em poliéster com elastano que não desbota.', 'semi-novo', 50.00, 0.00, NULL, 'G', 10, 1, 1, 1, '554.114.788-83', 54, 72),
	(129, 'Moleton Dragon Ball', 'Disponíveis nos tamanhos: PP, P, M, G e GG\r\nConsulte nossa tabela de tamanhos\r\nTecido em Moletom bem quentinho\r\nAcabamentos em bordados', 'novo', 110.00, 0.00, NULL, 'G', 10, 1, 1, 351, '554.123.654-41', 64, 151);
...
INSERT IGNORE INTO `sub_subcategorias` (`sub_codigo`, `sub_nome`, `sub_figura`, `cat_codigo`) VALUES
	(25, 'Óculos', NULL, 18),
	(26, 'Relógio', NULL, 18),
	(27, 'Bjoux', NULL, 18),
	(28, 'Cintos', NULL, 18),
...
INSERT IGNORE INTO `tip_tipo` (`tip_codigo`, `tip_nome_tipo`) VALUES
	(1, 'Administrador'),
	(2, 'Usuário');
...
INSERT IGNORE INTO `tme_tipo_mensagens` (`tme_codigo`, `tme_nome_tipo`) VALUES
	(1, 'Equipe Garimpo'),
...
-- Copiando dados para a tabela garimpao.usu_usuarios: ~19 rows (aproximadamente)
/*!40000 ALTER TABLE `usu_usuarios` DISABLE KEYS */;
INSERT IGNORE INTO `usu_usuarios` (`usu_cpf_cnpj`, `usu_nome`, `usu_sexo`, `usu_data_nasc`, `usu_email`, `usu_senha`, `usu_telefone`, `usu_data_cadastro`, `usu_status_cadastro`, `usu_foto_perfil`, `usu_nome_loja`, `usu_qtdd_vendas`, `usu_qtdd_vendas_canceladas`, `usu_qtdd_denuncia`, `usu_qtdd_compras`, `usu_qtdd_compras_canceladas`, `usu_medida_busto`, `usu_medida_cintura`, `usu_medida_calcado`, `usu_reputacao`, `usu_cadastroCompleto`, `usu_tentativas`, `tip_codigo`, `sub_codigo`) VALUES
	('1', 'Administrador', 'M', '1995-06-16', 'adm@adm', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(11) 4211-4124', '2018-03-31 01:14:30', 1, '\\FotosPerfis\\usuarios\\1\\1-Administrador.jpg', 'Lojinha do(a)Administrador', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 1, 258),
	('111.256.734-54', 'teste alterar', 'M', '1995-06-16', 'teste@teste', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(49) 8741-2123', '2018-05-26 04:11:26', 0, '../../themes/images/FOTOPERFIL/este.gif', 'Lojinha do(a)teste alterar', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 25),
	('121.212.214-32', 'Cardoso Marques', 'M', '1995-06-16', 'cardoso@marques', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(45) 8744-4111', '2018-06-25 03:29:47', 1, '\\FotosPerfis\\usuarios\\121.212.214-32\\250620183120127.jpg', 'Lojinha do(a)Cardoso Marques', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 151),
	('121.734.511-11', 'Rafael Santos', 'M', '1989-05-20', 'rafael@gmail.com', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(45) 4565-4645', '2018-06-15 13:11:59', 0, '\\FotosPerfis\\usuarios\\121.734.511-11\\150620181401103.jpg', 'Lojinha do(a)Rafael Santos', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 25),
	...
	('382.229.055-44', 'Rafael de Paula Santos', 'M', '1989-05-20', 'rafaelps15@hotmail.com', '3648eeef409016499f2d8976d884d211de7cf28f672a25c82b74410921353c196258d49f813b3bf6c7faf7e28d14da65876623073bf7dad6b8481c281e8a7cec', '(12) 9813-8637', '2018-06-24 23:02:17', 1, '\\FotosPerfis\\usuarios\\382.229.055-44\\240620180406181.png', 'Lojinha do(a)Rafael de Paula Santos', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 151),
	('436.606.008-65', 'gabriel de paula ', 'M', '1995-06-16', 'gabriel_ps15@hotmail.com', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(12) 3016-6654', '2018-05-25 20:17:11', 1, '\\FotosPerfis\\usuarios\\436.606.008-65\\250520181808824.jpg', 'Lojinha do(a)gabriel de paula ', 0, 0, 0, 2, 0, '', '', '', 0, 2, 0, 1, 72),
	('445.687.874-51', 'nerd girl', 'M', '1995-06-16', 'nerd@girl', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(11) 2315-4644', '2018-05-25 21:14:53', 1, '\\FotosPerfis\\usuarios\\445.687.874-51\\250520181646365.jpg', 'Lojinha do(a)nerd girl', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 151),
	...
	('475.878.548-0', 'joao da silva', 'M', '1999-04-10', 'joao@hotamils.com', '1d73a38e9aebe1bac7eb9661ea6b378b4e374dc099588976a1e1f7a7eb205ab2f4b62c3647024cd2eadbac076ce4b3f2b7ac692739de4628509831b039a331ff', '(12) 3122-2145', '2018-06-11 20:36:50', 0, '../../themes/images/FOTOPERFIL/este.gif', 'Lojinha do(a)joao da silva', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 25),
	('554.114.788-83', 'Comprador Garimpo', 'M', '1985-01-18', 'comprador@comprador', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(55) 4877-4121', '2018-06-26 18:27:34', 1, '\\FotosPerfis\\usuarios\\554.114.788-83\\260620182918772.jpg', 'Lojinha do(a)Comprador Garimpo', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 72),
	('554.123.654-41', 'Vendedor Garimpo', 'M', '1880-08-25', 'vendedor@garimpo', '6dc9e5b50ffaffef1f31f1e09a53df11ca5aab08ca5d18bb91f9289b3fa45cd9d4ebc6252efed23cd815f62b8d599eda624fda529ea88edb820dac7805999463', '(15) 6564-4564', '2018-06-26 18:38:41', 1, '\\FotosPerfis\\usuarios\\554.123.654-41\\260620183947521.jpg', 'Lojinha do(a)Vendedor Garimpo', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 72),
	('558.971.111-11', 'Comprador Garimpo', 'M', '1990-05-10', 'comprador@garimpo', '6dc9e5b50ffaffef1f31f1e09a53df11ca5aab08ca5d18bb91f9289b3fa45cd9d4ebc6252efed23cd815f62b8d599eda624fda529ea88edb820dac7805999463', '(56) 4774-4111', '2018-06-26 18:36:29', 1, '\\FotosPerfis\\usuarios\\558.971.111-11\\260620183720359.jpg', 'Lojinha do(a)Comprador Garimpo', 0, 0, 0, 0, 0, '', '', '', 0, 2, 0, 2, 25),
	('756.475.445-11', 'marcelo vidas', 'M', '1984-06-16', 'marcelo@vidas', 'c7d39eb8076cddec95735db4e0e094d3c4be197a0f885cbb514177b1017e056f87236d001b4c817df7ee17838d90910cb34134c9056a2937422aa6775f8c601c', '(12) 5468-7844', '2018-05-25 20:48:16', 1, '\\FotosPerfis\\usuarios\\756.475.445-11\\250520184954971.jpg', 'Lojinha do(a)marcelo vidas', 1, 0, 0, 0, 0, '', '', '', 100, 2, 0, 2, 151);
